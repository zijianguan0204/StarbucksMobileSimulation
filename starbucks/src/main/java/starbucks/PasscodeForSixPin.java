...
public class PasscodeForSixPin implements ITouchEventHandler, IDisplayComponent, IKeyPadObserver
{
    ITouchEventHandler nextHandler ;
    private int count = 0;
    /**
     * resetPasscoe6() for reset the variable of keypad
     */
    public void resetPasscode6()
    {
        count = 0;
    }
    ...
    public String display()
    {
        ...
        switch ( count % 6 )
        {
            ...
            case 6: value = "_ _ _ _ _ _" ; break ;
            default: value = "";
        }
        return value;
    }
